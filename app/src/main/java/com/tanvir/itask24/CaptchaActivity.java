...
public class CaptchaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        captchaSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(txt.isEmpty()){
                    Toast.makeText(CaptchaActivity.this, "Please Write Your Captcha", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    if(captcha.equals(txt)){
                        ...
                        Toast.makeText(CaptchaActivity.this, "Wrong Captcha", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void init() {
        ...
        localDb=new LocalDb(CaptchaActivity.this);
    ...
    public void  setCountText(){
        count=captchaDb.getCount(Common.cap1Db);
        if(count>10){
            captchaDb.setCaptcha(1,Common.cap1Db);
            captchaTv.setText("");
        }else{
    ...
    public void updateCount(){
        count++;
        captchaDb.setCaptcha(count,Common.cap1Db);
        setCountText();
    }
    ...
    private void sendUserToCaptchaActivity() {
        startActivity(new Intent(CaptchaActivity.this,MainActivity.class));
        finish();
    }
    ...
    private void showInterstitialAdd(){
        InterstitialAdListener interstitialAdListener = new InterstitialAdListener() {
            ...
            public void onInterstitialDismissed(Ad ad) {
                ...
                UserServices userServices=new UserServices(CaptchaActivity.this);
                if(count>10) {
                    userServices.updateUserState("cap1LastPlay");
                    belowLinearLayout.setVisibility(View.VISIBLE);
                    startOfferCountDown();
                }
                if(setting!=null){
                    userServices.setCoinIntoDb(String.valueOf(setting.getCap1()),"From Captcha  1");
                }
            }
    ...
    private void showOfferAdd(){
        InterstitialAdListener interstitialAdListener = new InterstitialAdListener() {
            ...
            public void onInterstitialDisplayed(Ad ad) {
                UserServices userServices=new UserServices(CaptchaActivity.this);
                userServices.updateUserState("cap1LastPlay");
                Toast.makeText(CaptchaActivity.this, " Click Add For Get Offer Coin", Toast.LENGTH_LONG).show();
